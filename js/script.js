...
function redirectToWhatsApp(){
    ...
    const whatsappURL = `https://api.whatsapp.com/send?phone=9360104074&text=Name:%20${encodedName}%0AEmail:%20${encodedEmail}%0AMessage:%20${encodedMessage}`;
